<template>
  <div class="table">
    <div class="manager-header">
      ...
      <div class="button">
        <el-button type="info" @click="searchCustomer" class="search" style="margin-top: 20px" plain>搜索</el-button>
        <el-button type="info" class="add" @click="openAdd()" v-if="user.identity === 'manager'" plain>新增</el-button>
      </div>
    </div>
    <el-table
        v-loading="loading"
